  ...
  items: [
    {
      ...
      specs: "Fits Toyota Camry 2019-2024",
    },
    {
...
export const Receipt = () => (
  <Html>
    <Head />
    <Preview>Your AutoPart Order Confirmation #{orderData.orderNumber}</Preview>
    <Body style={main}>
      <Container style={container}>
          ...
          <Section key={index} style={itemContainer}>
            <Row>
              ...
              <Column>
                ...
                <Text style={itemSpecs}>{item.specs}</Text>
        ...
        <Section style={global.defaultPadding}>
          <Row>
            <Column style={{ width: "50%" }}>
              ...
              <Text style={global.value}>{orderData.orderNumber}</Text>
            </Column>
            <Column style={{ width: "50%" }}>
              <Text style={global.label}>Order Date</Text>
              <Text style={global.value}>{orderData.orderDate}</Text>
            </Column>
          </Row>
        </Section>
        ...
        <Section style={footer}>
          <Text style={footer.text}>
            Questions about your order? Visit our Help Center or contact us at
            support@autopart.com
          </Text>
          <Text style={footer.text}>
